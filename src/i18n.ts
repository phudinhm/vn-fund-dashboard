...
const DICT = {
  ...
  // ── DCA storm block ──
  'storm.bear2018': { vi: 'bear market 2018-2019', en: 'the 2018–2019 bear market' },
  'storm.covid2020': { vi: 'cú sập COVID tháng 3/2020', en: 'the COVID crash of March 2020' },
  'storm.bear2022': { vi: 'bear market 2022', en: 'the 2022 bear market' },
  'storm.calmTitle': { vi: '⛅ Giai đoạn êm ả', en: '⛅ A calm stretch' },
  'storm.calmBody': {
    vi: 'Suốt kỳ đầu tư này, danh mục không trải qua cơn bão nào đáng kể. Drawdown tệ nhất chỉ <b>{dd}%</b>. Thị trường chứng khoán Việt Nam là thị trường cận biên, từ bull sang bear diễn ra chóng vánh, có thể bạn đang ở giai đoạn thuận lợi. Đừng vội kết luận DCA luôn êm ả như vậy. Thử chọn khoảng thời gian dài hơn (bao trùm 2018-2019 hoặc 2022) để thấy bức tranh đầy đủ hơn.',
    en: 'Over this period the portfolio never hit a real storm — the worst drawdown was only <b>{dd}%</b>. Vietnam is a frontier market where the turn from bull to bear is abrupt, so you may simply have caught a kind stretch. Do not conclude that DCA is always this smooth. Try a longer range, covering 2018–2019 or 2022, for the fuller picture.',
  },
  'storm.title': { vi: '🌊 Kiên trì qua bão', en: '🌊 Riding out the storm' },
  'storm.intro': {
    vi: 'Hành trình DCA không bao giờ là một đường thẳng. Đây là những cơn bão mà danh mục {who} đã trải qua.',
    en: 'A DCA journey is never a straight line. These are the storms {who} lived through.',
  },
  'storm.whoYours': { vi: 'của bạn', en: 'your portfolio' },
  'storm.whoNamed': { vi: '{name} của bạn', en: 'your {name} portfolio' },
  'storm.stat.worstDD': { vi: 'Drawdown tệ nhất', en: 'Worst drawdown' },
  'storm.stat.needToBreakEven': { vi: 'cần +{pct}% để hòa vốn', en: 'needs +{pct}% to break even' },
  'storm.stat.at': { vi: 'ở {name}', en: 'in {name}' },
  'storm.stat.troughDate': { vi: 'Thời điểm chạm đáy', en: 'Date of the trough' },
  'storm.stat.coincides': { vi: 'trùng {bear}', en: 'coincides with {bear}' },
  'storm.stat.recovery': { vi: 'Thời gian hồi phục', en: 'Time to recover' },
  'storm.stat.months': { vi: '{n} tháng', en: '{n} months' },
  'storm.stat.notRecovered': { vi: 'chưa hồi phục', en: 'not recovered' },
  'storm.stat.stormCount': { vi: 'tổng {n} cơn bão trong kỳ', en: '{n} storms in the period' },
  'storm.fundChartTitle': { vi: 'Giá quỹ sập bao nhiêu?', en: 'How far did the fund fall?' },
  'storm.fundChartNote': {
    vi: 'Khoảng cách từ đỉnh giá quỹ. Đây là "bão thị trường thật", đo bằng TWRR nên đã loại ảnh hưởng của việc bạn nạp tiền đều đặn.',
    en: 'The distance below the fund’s peak price. This is the real market storm: measured with TWRR, so your steady contributions do not affect it.',
  },
  'storm.accountChartTitle': { vi: 'Số dư tài khoản sập bao nhiêu?', en: 'How far did your balance fall?' },
  'storm.accountChartNote': {
    vi: 'Khoảng cách từ đỉnh số dư tài khoản thực tế của bạn. Đây là thứ bạn thấy khi mở app quỹ.',
    en: 'The distance below the peak of your actual account balance. This is what you see when you open the fund app.',
  },
  'storm.softened': {
    vi: 'Giá quỹ sập <b>-{market}%</b>, nhưng số dư tài khoản lúc tệ nhất chỉ <b>-{account}%</b>. Khoảng chênh <b>{gap} điểm %</b> là phần DCA cứu vớt: mỗi lần bạn nạp thêm tiền giữa bão, peak số dư được kéo lên chậm, đáy cũng không sập sâu như giá quỹ.',
    en: 'The fund fell <b>-{market}%</b>, but your balance at its worst was only <b>-{account}%</b>. That <b>{gap} point</b> difference is what DCA rescued: every contribution made during the storm slows the peak from rising and keeps the trough from falling as far as the fund did.',
  },
  'storm.tableTitle': { vi: 'Các đợt sụt giảm lớn nhất', en: 'Largest drawdowns' },
  'storm.tableNote': {
    vi: 'Top 5 đợt sụt từ 5% trở lên của mỗi danh mục. "Dưới đỉnh" là tổng thời gian từ lúc lập đỉnh đến khi vượt lại đỉnh cũ.',
    en: 'The five largest falls of 5% or more for each portfolio. "Underwater" is the total time from setting the peak to reclaiming it.',
  },
  'storm.col.drawdown': { vi: 'Sụt giảm', en: 'Drawdown' },
  'storm.col.fromPeak': { vi: 'Từ đỉnh', en: 'From peak' },
  'storm.col.trough': { vi: 'Chạm đáy', en: 'Trough' },
  'storm.col.recovered': { vi: 'Hồi phục', en: 'Recovered' },
  'storm.col.underwater': { vi: 'Dưới đỉnh', en: 'Underwater' },
  'storm.years': { vi: '{v} năm', en: '{v} yr' },
  'storm.months': { vi: '{v} tháng', en: '{v} mo' },
  'storm.days': { vi: '{v} ngày', en: '{v} days' },
  'storm.takeaway.recoveredNamed': {
    vi: 'Đáy sâu nhất của danh mục <b>{name}</b> là ',
    en: 'The deepest trough for <b>{name}</b> was ',
  },
  'storm.takeaway.recoveredUnnamed': { vi: 'Đáy sâu nhất là ', en: 'The deepest trough was ' },
  'storm.takeaway.recoveredBody': {
    vi: '<b>-{dd}%</b> vào <b>{date}</b>{bear}. Từ đáy đó, giá cần tăng <b>+{recovery}%</b> chỉ để hòa vốn, sụt càng sâu thì càng khó gỡ lại. Nếu bạn hoảng loạn bán lúc đó, toàn bộ khoản lỗ sẽ hiện thực hóa. Nhưng bạn đã kiên trì nạp tiền thêm, và thị trường hồi phục về đỉnh cũ sau <b>{months} tháng</b>. Đó là lý do vì sao đầu tư đều đặn qua từng tháng quan trọng hơn đoán đỉnh đoán đáy thị trường.',
    en: '<b>-{dd}%</b> in <b>{date}</b>{bear}. From there the price needed to rise <b>+{recovery}%</b> just to break even — the deeper the fall, the harder it is to claw back. Panic-selling then would have made the whole loss real. You kept contributing instead, and the market reclaimed its old high <b>{months} months</b> later. That is why contributing month after month matters more than calling tops and bottoms.',
  },
  'storm.takeaway.bearSuffix': { vi: ', đúng vào {bear}', en: ', right in {bear}' },
  'storm.takeaway.underwaterNamed': { vi: 'Danh mục <b>{name}</b> chạm đáy ', en: '<b>{name}</b> bottomed out at ' },
  'storm.takeaway.underwaterUnnamed': { vi: 'Danh mục chạm đáy ', en: 'The portfolio bottomed out at ' },
  'storm.takeaway.underwaterBody': {
    vi: '<b>-{dd}%</b> vào <b>{date}</b>{bear} và hiện vẫn chưa hồi phục về đỉnh cũ. Để hòa vốn từ đáy này, giá cần tăng <b>+{recovery}%</b>, một lời nhắc rằng sụt càng sâu thì càng khó gỡ lại. Thị trường Việt Nam là thị trường cận biên, từ bull sang bear diễn ra chóng vánh. Có thể bạn đang trong giai đoạn bão. Hãy kiên trì nạp tiền đều đặn qua từng tháng, mua được nhiều chứng chỉ quỹ hơn khi giá thấp. Lịch sử cho thấy các bear market trước đây (2018-2019, 2022) đều đã hồi phục.',
