/**
 * Nội dung tiếng Việt của khối "Giải Thích Khái Niệm" ở tab DCA.
 *
 * Cùng lý do với tab Minh Bạch Hoá (xem MethodologyParts.tsx): đây là một bài
 * giải thích có công thức, ví dụ số và bảng đối chiếu, nên để nguyên hai tài
 * liệu song song dễ đọc và dễ giữ đồng bộ hơn là cắt thành mấy chục key rời.
 */
export function GlossaryVi() {
  return (
    <>
          {/* ── Intro ── */}
          <p>
