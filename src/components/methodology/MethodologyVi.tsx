/**
 * Nội dung tiếng Việt của tab "Minh Bạch Hoá".
 *
 ...
 * nhật cả file này lẫn MethodologyEn.tsx cho khớp.
 */
import { Formula, Where, SeenAt, Example, Section } from './MethodologyParts'

export const SECTION_LABELS_VI = [
  '0. Dữ liệu lấy từ đâu',
  '1. Mô phỏng DCA chạy thế nào',
  '2. Bốn cách đo lợi nhuận',
  '3. Đo rủi ro',
  '4. Các kịch bản hành vi',
  '5. Dự phóng tương lai (Endgame)',
]

export function MethodologyVi() {
  return (
    <>
      {/* ─────────────────────────── 0. DỮ LIỆU ─────────────────────────── */}
      <Section id="m-data" title="0. Dữ liệu lấy từ đâu">
        ...
        <SeenAt where="Xuất hiện ở tab So Sánh">mục "Chất lượng dữ liệu" minh bạch khoảng dữ liệu và các khoảng trống của từng quỹ.</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở 4 tab">tuỳ chọn "Tiết kiệm ngân hàng (lãi suất cố định, tự nhập)" trong danh sách chọn quỹ ở tab DCA, So Sánh, Tái Cân Bằng và Bitcoin, kèm ô nhập lãi suất %/năm ngay bên cạnh.</SeenAt>
      </Section>
      ...
      <Section id="m-returns" title="2. Bốn cách đo lợi nhuận">
        ...
        <SeenAt where="Xuất hiện ở tab DCA">cột "Lợi nhuận tích lũy" trong Bảng thống kê, và ô "Lợi nhuận" phần "Hành trình của bạn".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">cột "CAGR" trong Bảng thống kê.</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">cột "MWRR" trong Bảng thống kê, và cột "MWRR" ở các bảng kịch bản hoảng loạn / tăng tiền.</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">bảng "Hiệu suất danh mục của bạn từng năm" trong phần "Hiệu suất đầu tư".</SeenAt>
      </Section>
      ...
      <Section id="m-risk" title="3. Đo rủi ro">
        ...
        <SeenAt where="Xuất hiện ở tab DCA">hai biểu đồ "Giá quỹ sập bao nhiêu?" và "Số dư tài khoản sập bao nhiêu?" trong "Kiên trì qua bão".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">các cột "Sụt giảm tối đa / TB / Dưới đỉnh lâu nhất" trong Bảng thống kê, và bảng "Các đợt sụt giảm lớn nhất".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">cột "Biến động" trong Bảng thống kê.</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">cột "Profit Factor" trong Bảng thống kê.</SeenAt>
      </Section>
      ...
      <Section id="m-behavior" title="4. Các kịch bản hành vi">
        ...
        <SeenAt where="Xuất hiện ở tab DCA">bảng và biểu đồ "Nếu bạn hoảng loạn dừng đầu tư khi thấy đỏ?".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">bảng "Ngược lại, nếu bạn tăng tiền khi thấy đỏ?".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">mục "Nếu bạn bắt đầu ở thời điểm khác thì sao?" với biểu đồ phân phối và câu "CAGR thực tế của bạn... nằm ở đâu".</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">bảng "Cùng 100 triệu, vào ở thời điểm khác nhau".</SeenAt>
      </Section>
      ...
      <Section id="m-future" title="5. Dự phóng tương lai (Endgame)">
        ...
        <SeenAt where="Xuất hiện ở tab DCA">phần "Endgame" với biểu đồ dự phóng tương lai.</SeenAt>
        ...
        <SeenAt where="Xuất hiện ở tab DCA">biểu đồ Monte Carlo trong phần "Endgame".</SeenAt>
      </Section>
